        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="box-artigo">
                    ...
                    <h6><?php
                            if (isset($_SESSION['usuario'])) {
                                echo '<p class="welcome-message">Seja bem-vindo, ' . $_SESSION['usuario'] . '</p>';
                            }
                            ?></h6>
                ...
                <div class="container mt-5">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewProjectModal" data-project-name="Projeto 1" data-project-description="Descrição do Projeto 1">Ver Detalhes</a>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewProjectModal2" data-project-name="Projeto 1" data-project-description="Descrição do Projeto 1">Ver Detalhes</a>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewProjectModal3" data-project-name="Projeto 1" data-project-description="Descrição do Projeto 3.">Ver Detalhes</a>
                    ...
                    <div class="modal fade" id="viewProjectModal2" tabindex="-1" aria-labelledby="viewProjectModalLabel2" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                    ...
                    <div class="modal fade" id="viewProjectModal3" tabindex="-1" aria-labelledby="viewProjectModalLabel3" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
